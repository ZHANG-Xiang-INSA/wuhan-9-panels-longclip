...
const T = {
  ...
  en: {
    ...
    f_clip: c => `Clip ${c}, formed part, six views`,
...
async function files() {
  ...
  const F = [
    ...
    ['downloads/R1_LC-1366_CN_EN.png', t('f_clip')('LC-1366'), all],
    ['downloads/R2_RC-50_CN_EN.png', t('f_clip')('RC-50'), all],
    ['downloads/R3_PK-3T03_CN_EN.png', t('f_clip')('PK-3T03'), all],
    ['downloads/R4_PK-8T02_CN_EN.png', t('f_clip')('PK-8T02'), all],
